...
// Client implements client.Transport with Resty.
type Client struct {
	baseURL *url.URL
...
// NewWithRestyClient builds a Client around restyClient. Define whether the
// supplied client is configured in place, and disable retries or redirects
// that would change the observable one-request contract.
