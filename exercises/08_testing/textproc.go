// Package textproc provides small, already-implemented text-processing
// helpers. Unlike earlier exercises, the implementations below are complete:
// your job in this module is to write the tests, benchmark, and fuzz target
// that exercise them. See README.md for the task list.
package textproc
